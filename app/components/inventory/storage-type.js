...
export default class InventoryStorageTypeComponent extends Component {
    ...
    handleAddInventory() {
        ...
        if (this.inputFieldNumbers.length == 0 || !Object.values(lastObject).some(value => value === null)) {
            this.inputFieldNumbers.pushObject({ 'type': null, 'description': '' });
        } else {
    ...
    async HandleSave() {
        ...
        if (this.inputFieldNumbers.length === 1) {
            ...
            // if last obj des contains data but type is empty
        ...
        // if value is empty and type also null remvoe the extra obj before post request
        if (lastObj.type === null && lastObj.description === "") {
